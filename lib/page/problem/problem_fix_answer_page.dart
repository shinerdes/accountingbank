...
class ProblemFixAnswerPage extends ConsumerStatefulWidget {
  const ProblemFixAnswerPage(
      {super.key,
      required this.id,
...
class _ProblemFixAnswerPageState extends ConsumerState<ProblemFixAnswerPage> {
...
class AnswerParams {
  ...
  AnswerParams(this.id, this.password);

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AnswerParams &&
