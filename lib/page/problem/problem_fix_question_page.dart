...
class ProblemFixQuestionPage extends ConsumerStatefulWidget {
  const ProblemFixQuestionPage(
      {super.key,
      required this.id,
      required this.title,
...
class _ProblemFixQuestionPageState
    extends ConsumerState<ProblemFixQuestionPage> {
...
class QuestionParams {
  ...
  QuestionParams(this.id, this.password);
