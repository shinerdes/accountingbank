...
final removeAnswerRepositoryProvider =
    Provider((ref) => RemoveAnswerRepository());

class RemoveAnswerRepository {
  ...
  Future<void> deleteUser(int id) async {
    try {
      final response = await dio
          .delete("http://13.124.70.40/api/v1/answer/$id"); // ✅ DELETE request
